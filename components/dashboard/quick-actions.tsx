...
export function QuickActions() {
  ...
  const secondaryActions = [
    ...
    },
    {
      ...
      icon: Settings,
      description: "Điều chỉnh cài đặt",
      color: "indigo",
    },
  ];
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left flex-1">
                      <div className={`font-bold ${action.textColor} text-lg`}>
                        {action.label}
                      </div>
          ...
          <div className="space-y-2">
            {utilityActions.map((action, index) => {
              ...
              return (
                <button
                  key={index}
                  className="group w-full flex items-center gap-3 p-3 hover:bg-gray-50 rounded-xl transition-colors duration-200"
                >
