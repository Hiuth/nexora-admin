    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div className="text-sm text-gray-600">
          Hiển thị {products.length} trong số {totalItems} sản phẩm
        </div>
        ...
        {!hasMore && products.length > 0 && totalItems === 0 && (
      ...
      {scrollMode === "button" && !hasMore && products.length > 0 && (
        <div className="py-6 text-center">
          <div className="inline-flex items-center px-4 py-2 bg-green-50 text-green-700 text-sm rounded-lg border border-green-200">
            ...
            Đã hiển thị tất cả {totalItems > 0 ? totalItems : products.length} sản phẩm
          </div>
        </div>
      )}
    </div>
